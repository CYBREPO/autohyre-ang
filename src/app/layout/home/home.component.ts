...
import { Carousel, locations, vehicleModels } from 'src/app/constants/constant';
...
export class HomeComponent {
  ...
  customOptions: OwlOptions = Carousel.customOptions;
  customHomeOptions: OwlOptions = Carousel.customHomeOptions;
